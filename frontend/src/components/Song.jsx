  ...
  return (
    <li className="song-item relative flex flex-col items-center p-2 sm:p-4">
      ...
      <Link to={`/songs/${song._id}`} className="relative group">
        ...
        <span className="absolute bottom-2 left-2 text-black text-lg bg-transparent px-2 py-1 rounded transition-opacity duration-300 group-hover:opacity-80 block sm:hidden">
          {song.name}
        </span>
      </Link>
    </li>
